...
import { enemyTypes } from "./data/animationDatabase.js";
import { characterDatabase, createCharacterProfiles } from "./data/characterDatabase.js";
import { MAP_CATEGORY_LABELS, locations, mapSurveySites } from "./data/locationDatabase.js";
...
const characterProfiles = createCharacterProfiles({
  avaBelmontPortraitUrl,
  peterAshfieldPortraitUrl,
  alynnePortraitUrl,
  luisPortraitUrl,
});
const itemCatalog = {
