...
- Automated tests currently cover seeded random generation, core item/inventory rules, save handling, and procedural/handcrafted mission-layout invariants; gameplay still requires focused browser verification.
