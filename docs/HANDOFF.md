...
- Automated tests currently cover seeded random generation, core item/inventory rules, and save serialization/parsing; gameplay still requires focused browser verification.
