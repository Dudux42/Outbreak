...
- Automated tests currently cover seeded random generation, core item/inventory rules, save handling, and mission-layout generation/validation invariants; gameplay still requires focused browser verification.
