...
- Constants, enemy types, and runtime item stats.
...
### `src/data/characterDatabase.js`

Owns survivor profile metadata, animation-set references, portrait bindings supplied by the runtime, and the active/future character roster. Character switching, loadout synchronization, and save compatibility remain in `src/main.js`.
...
### `src/systems/inventory/inventoryRules.js`
